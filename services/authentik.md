...
1. **OIDC Natif (OpenID Connect / OAuth2)** : L'application gère son propre flux d'authentification et dialogue directement avec Authentik (ex. [Grafana](/services/monitoring), [Vaultwarden](/services/vaultwarden), [Headplane](/services/headscale-headplane), [Zipline](/services/zipline), [Forgejo](/services/forgejo)).
